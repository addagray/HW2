...
class AgePredictor:
    ...
    def _download_models(self):
        ...
        self._download(GENDER_PROTO, "gender_deploy.prototxt")
        self._download(GENDER_MODEL, "gender_net.caffemodel")

    def predict_attributes(self, image_bytes):
        ...
        predicted_gender = GENDER_LIST[gender_index]

        return {
            "age_bracket": predicted_age,
